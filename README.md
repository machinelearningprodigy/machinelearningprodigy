...
<h2 align="center" style="display: flex; align-items: center; justify-content: center; padding: 20px; background-color: #0d1117; color: white; gap: 15px;">
  <img 
    ...
    height="50"
  />
  <span style="font-size: 32px; font-weight: 600; margin-top: -10px;">Language & Coding Activity</span>
</h2>
